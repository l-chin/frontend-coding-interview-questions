...
test(t => t.is(isPrimeTest2(0), false))
test(t => t.is(isPrimeTest2(1), false))
test(t => t.is(isPrimeTest2(2), true))
test(t => t.is(isPrimeTest2(9), false))
test(t => t.is(isPrimeTest2(17), true))
test(t => t.is(isPrimeTest2(25), false))

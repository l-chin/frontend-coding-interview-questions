...
test(t => t.deepEqual(filterTest4([1, 2, 3, 4], n => n < 3), [1, 2]))

test(t => t.deepEqual(filterTest5([1, 2, 3, 4], n => n < 3), [1, 2]))

test(t => t.deepEqual(filterTest6([1, 2, 3, 4], n => n < 3), [1, 2]))